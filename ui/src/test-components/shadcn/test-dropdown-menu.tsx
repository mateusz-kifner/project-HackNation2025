...
function TestDropdownMenu() {
	...
	const [showStatusBar, setShowStatusBar] = useState<CheckedState>(true);
	const [showActivityBar, setShowActivityBar] = useState<CheckedState>(false);
	const [showPanel, setShowPanel] = useState<CheckedState>(false);
